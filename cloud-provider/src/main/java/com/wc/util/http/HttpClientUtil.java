...
public class HttpClientUtil {
    ...
    /**
     * @param url 请求路径
     * @Title: doGetPathHeader
     * @Description: get方式
     * @author Mundo
     */
    public static String doGetPathHeader(String url, String headerValue) {
        ...
        try {
            ...
            // 创建get请求
            httpGet = new HttpGet(uri);
            httpGet.addHeader("appSecret", headerValue);
            logger.info("访问路径：" + uri);
            HttpResponse response = httpClient.execute(httpGet);
            if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {// 返回200，请求成功
                // 结果返回
     ...
     * @author Mundo
     */
    public static String doGetAndHeader(String url, Map<String, String> params, String headerValue) {
     ...
     * @author Mundo
     */
    public static String doAuthGetAndHeader(String url, String authorization, String authAppSecret) {
        // 返回结果
        String result = "";
        // 创建HttpClient对象
        HttpClient httpClient = HttpClientBuilder.create().build();
        ...
        try {
            ...
            httpGet.addHeader("appSecret", authAppSecret);
     ...
     * @author Mundo
     */
    public static String sendJsonStrAndHeader(String url, String params, String headerValue) {
        String result = "";
        ...
        try {
            httpPost.addHeader("Content-type", "application/json; charset=utf-8");
            httpPost.addHeader("appSecret", headerValue);
            httpPost.setHeader("Accept", "application/json");
            if (StringUtils.isNotBlank(params)) {
                httpPost.setEntity(new StringEntity(params, Charset.forName("UTF-8")));
            }
